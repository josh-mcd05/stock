...
5. Creating a portfolio (for both text interface and GUI)
6. Adding/removing/getting stock from portfolio
7. Making multiple portfolios (for both text interface and GUI)
...
12. Purchase a specific number of shares of a specific stock on a specified date, and add them to the portfolio (for both text interface and GUI)
13. Sell a specific number of shares of a specific stock on a specified date from a given portfolio (for both text interface and GUI)
14. Determine the composition of a portfolio at a specific date. Note that the composition may change over time.
The composition must include (a) the list of stocks and (b) the number of shares of each stock (for both text interface and GUI)
15. Determine the value of a portfolio on a specific date (to be exact, the end of that day).
...
(for both text interface and GUI)
...
17. Persist a portfolio so that it can be saved to a text file and a text file can be loaded as a portfolio. (for both text interface and GUI)
